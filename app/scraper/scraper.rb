...
class Scraper 
    ...
    def ebay_site
      ...
      {
        product_link: card.xpath(".//img[@class='s-item__image-img']").attr('src').to_s,
    ...
    def jumia_site
        ...
        new = articles.map.with_index do |product, index|
            product={
                ...
                store: 'Jumia',
                product_link: product.xpath(".//img[@class='img']").to_s,
    ...
    def amazon_site
        ...
        new = articles.map.with_index do |product, index|
          ...
          {
            product_link: product.xpath(".//img[@class='s-image']").attr('src').to_s,
